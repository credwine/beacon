...
def main():
    ...
    if not check_ollama():
        print("WARNING: Ollama is not running. Beacon needs Ollama + Gemma 4 for AI features.")
        print("Start Ollama, then run: python run.py --setup")
        print()

    print("Starting Beacon on http://localhost:8000")
    subprocess.run([
